...
class DPOTrainer(Trainer):
    ...
    def __init__(
        ...
        if loss_type != "sigmoid" and label_smoothing > 0:
            warnings.warn(
    ...
    def _prepare_deepspeed(self, model: PreTrainedModelWrapper):
        # Adapted from accelerate: https://github.com/huggingface/accelerate/blob/739b135f8367becb67ffaada12fe76e3aa60fefd/src/accelerate/accelerator.py#lenN473
    ...
    def concatenated_forward(
        self, model: nn.Module, batch: Dict[str, Union[List, torch.LongTensor]], keep_org_logps=False
    ...
    def get_batch_loss_metrics(
        ...
        if self.loss_type == "tdpo":
            ...
            ) = self.concatenated_forward(model, batch, keep_org_logps=True)
