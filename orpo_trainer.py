...
class ORPOTrainer(Trainer):
    ...
    def __init__(
        ...
        simpo_lambda: Optional[float] = 0.5
    ):
        ...
        if max_completion_length is None and self.is_encoder_decoder:
            warnings.warn(
        ...
        self.simpo_lambda = simpo_lambda
        self.beta = beta
        ...
        with PartialState().local_main_process_first():
            ...
            train_dataset = train_dataset.map(self.tokenize_row, num_proc=dataset_num_proc)
            if eval_dataset is not None:
                eval_dataset = eval_dataset.map(self.tokenize_row, num_proc=dataset_num_proc)
    ...
    def odds_ratio_loss(
        ...
        if self.loss_type == "simpo":
            ...
            gamma_logratios = self.simpo_lambda / self.beta
            log_odds = pi_logratios - gamma_logratios
        else:
